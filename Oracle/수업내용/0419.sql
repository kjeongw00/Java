...
ALTER SYSTEM KILL SESSION '739, 6171' IMMEDIATE;
...
--시퀀스 2개 생성
--옵션추가한 시퀀스 생성
CREATE SEQUENCE EMP_CO_END_SQE
    START WITH 1
    INCREMENT BY 2
    MAXVALUE 10
    NOMINVALUE
...
VALUES(EMP_CO_ENO_SEQ1.NEXTVAL, 'A', '개발', 0, SYSDATE, 3000, 100, 0);
